...
declare -a tools=(bak2dvd bash-snippets cheat cloudup crypt cryptocurrency currency geo lyrics meme movies newton pwned gist qrify short siteciphers stocks taste todo transfer weather ytview)
